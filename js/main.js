...
window.onload = function () {
    ...
    document.addEventListener('rotarydetent', function(ev) {
        ...
        if (direction == 'CW' & coutner == "life") {
        	life_points = life_points + 1;
        	box.innerHTML = life_points.toString();
        }
        else if (direction == 'CW' & counter == "poison" & poison_counters < 10){
        	poison_counters = poison_counters + 1;
        	box.innerHTML = poison_counters.toString();
        }
        
        if (direction == 'CCW' & counter == "life" & life_points > 0 ) {
        	life_points = life_points - 1;
        	box.innerHTML = life_points.toString();
        }
        else if(direction == 'CCW' & counter == "poison" & poison_counters > 0){
        	poison_counters = poison_counters - 1;
        	box.innerHTML = poison_counters.toString();
        }
    });
